    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-[#171d52] shadow-md border-b border-[#26355f]">
      ...
      <div className="flex items-center gap-4 md:gap-8">
        {loading ? (
          ...
          <>
            <Link className={`text-[0.65rem] md:text-xs font-bold tracking-widest uppercase transition-colors ${pathname === '/' ? 'text-[#8eafe3]' : 'text-[#fffde9] hover:text-[#8eafe3]'}`} href="/">Home</Link>
            <Link className={`text-[0.65rem] md:text-xs font-bold tracking-widest uppercase transition-colors ${pathname?.includes('/about') ? 'text-[#8eafe3]' : 'text-[#fffde9] hover:text-[#8eafe3]'}`} href="/#about">About</Link>
            ...
            <Link className={`text-[0.65rem] md:text-xs font-bold tracking-widest uppercase transition-colors ${pathname?.includes('/calendar') ? 'text-[#8eafe3]' : 'text-[#fffde9] hover:text-[#8eafe3]'}`} href="/#calendar">Calendar</Link>
