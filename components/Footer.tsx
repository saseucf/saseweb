    ...
    return (
        <footer className="bg-[#171d52] border-t border-[#26355f] py-8 px-6 mt-auto">
            ...
            <div className="max-w-7xl mx-auto text-center mt-6 text-xs font-semibold text-[#8eafe3] opacity-60 uppercase tracking-widest">
                &copy; {new Date().getFullYear()} Society of Asian Scientists and Engineers - UCF Chapter
            </div>
        </footer>
    );
}
...
function SocialLink({ href, icon, label }: { href: string; icon: string; label: string }) {
    const icons: Record<string, React.ReactNode> = {
        ...
        knightconnect: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" /></svg>
        ),
    };
