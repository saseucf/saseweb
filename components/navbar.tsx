...
import { FaInstagram, FaLinkedin, FaChessKnight, FaDiscord } from "react-icons/fa";
import AOS from "aos";
        ...
        <div className={geist.className}>
            <div className="p-2 flex items-center">
                <Link href={"/"} className="flex-shrink-0">
                    <Image src={saselogo} alt="saselogo" height={100} width={100} className="flex-none" />
                </Link>
                        ...
                        <NavigationMenuList>
                            ...
                            <NavigationMenu>
                                <NavigationMenuItem>
                                    ...
                                    <NavigationMenuContent>
                                        <NavigationMenuLink asChild>
                                            <Link href="https://www.instagram.com/saseucf/">
                                                <p>
                                        ...
                                        <NavigationMenuLink asChild>
                                            <Link href="https://www.linkedin.com/company/ucf-sase/">
                                                <p>
                                        ...
                                        <NavigationMenuLink asChild>
                                            <Link href="https://discord.gg/PK8e6KwAQS">
                                                <p>
                                                    <FaDiscord className="inline" /> Discord
                                                </p>
                                            </Link>
                                        </NavigationMenuLink>
                                        <NavigationMenuLink asChild>
                                            <Link href="https://knightconnect.campuslabs.com/engage/organization/saseucf">
                                                <p className="whitespace-nowrap">
                                                    <FaChessKnight className="inline" /> KnightConnect
                                                </p>
                                            </Link>
                                        </NavigationMenuLink>
                                    </NavigationMenuContent>
                        ...
                        {aboutMenuOpen && (
                            <div className="">
                                <Link href={"/about/board"} onClick={() => setMobileMenuOpen(false)}>
                                    <div className="flex items-center gap-2 py-2">Board</div>
                                </Link>
                                <Link href={"/about/sponsors"} onClick={() => setMobileMenuOpen(false)}>
                                    <div className="flex items-center gap-2 py-2">Sponsors</div>
                                </Link>
                            </div>
                        )}
                            ...
                            <div className="">
                                <div className="flex flex-col gap-2 py-2">
                                    ...
                                    <p>
                                        ...
                                        <Link href="https://knightconnect.campuslabs.com/engage/organization/saseucf" className="whitespace-nowrap">KnightConnect</Link>
                                    </p>
                                </div>
                            </div>
                        )}
