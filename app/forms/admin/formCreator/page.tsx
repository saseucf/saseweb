    ...
    <main className="sase-page sase-creator-page pt-[120px]">
      ...
      <div className="sase-page-header flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h1>Form Creator</h1>
          <p className="mt-2 text-[#64708c]">Shape a clear, welcoming form for the SASE community.</p>
        </div>
        {!formId && (
          <button 
      ...
      <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#e2e8f0] p-8 max-w-3xl mx-auto flex flex-col gap-5 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          <div className="flex flex-col gap-1.5">
            <label className="text-[10px] uppercase font-bold tracking-wider text-[#64708c]">URL Slug</label>
            <input
              type="text"
