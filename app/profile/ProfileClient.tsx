...
export default function ProfileClient({ 
    ...
    checkout: MembershipCheckoutConfigurationResult;
    initialAttendances: AttendedEvent[];
    ...
    return (
        <main className="sase-page pt-[120px] sase-member-page">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                {/* Connected Accounts */}
                <section className="sase-content-section border border-border bg-card shadow-sm rounded-xl p-6 sm:p-8">
                    <h2 className="text-xl font-bold mb-6 tracking-tight">Connected Accounts</h2>
                    <div className="flex items-center justify-between p-4 rounded-xl border border-border bg-muted/30">
                        <div className="flex items-center gap-4">
                            <div className="bg-[#5865F2] p-2 rounded-lg text-white shrink-0">
                            ...
                            <div>
                                <div className="font-bold text-foreground">Discord</div>
                                <div className="text-sm text-muted-foreground font-medium">
                                    {discordLinked ? discordUsername || "Connected" : "Not connected"}
                                </div>
                            </div>
                        </div>
                        
                        {discordLinked ? (
                            <span className="text-xs font-bold uppercase tracking-wider text-emerald-700 bg-emerald-100 border border-emerald-200 px-3 py-1.5 rounded-full shrink-0">
                                Connected
                            </span>
                        ) : (
                            <button
                                onClick={async () => {
                                    toast.loading("Redirecting to Discord...", { id: "discord-link" });
                                    ...
                                    if (error) {
                                        toast.error(error.message, { id: "discord-link" });
                                    }
                                }}
                                className="bg-[#5865F2] hover:bg-[#4752C4] text-white px-4 py-2 rounded-lg font-bold text-sm transition-colors shrink-0 shadow-sm"
                            >
                                Connect
                            </button>
                        )}
